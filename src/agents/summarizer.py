...
async def summarize_step(state:AgentState):
    ...
    primary_model_with_tools = gemini_3_1_flash_model.with_structured_output(DailySummaryOutput)
    fallback_model_with_tools = gemini_3_5_flash_model.with_structured_output(DailySummaryOutput)
